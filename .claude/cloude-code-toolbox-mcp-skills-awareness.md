...
_Generated: 2026-08-08T06:45:24.549Z_
...
Workspace `mcp.json` _(folder: Website_bitrms)_

- **d:\bitrms\Website_bitrms\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Nooruddin\.claude.json** — _File exists — no servers defined_
